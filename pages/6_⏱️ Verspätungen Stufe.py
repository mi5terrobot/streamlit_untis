...
prepared_df = get_prepared_data(exclude_names=True, exclude_absence_reasons=False)
...
display_df = format_tardiness_result(summary_df.loc[summary_df["tardiness_count"] >= selected_min_tardiness].copy())
if display_df.empty:
...
st.dataframe(
    ...
    column_config={
        ...
        "Ø Minuten": st.column_config.NumberColumn("Ø Minuten", format="%.1f", width="small"),
    },
)
